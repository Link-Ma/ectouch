...
/* 项目目录 */
define('APP_PATH', TOUCH_PATH . 'modules/'. ucfirst(BIND_MODULE) .'/');
/* 项目类库目录 */
define('LIB_PATH', APP_PATH);
/* 模板目录 */
define('TMPL_PATH', APP_PATH . 'View/');
/* 运行时目录 */
define('RUNTIME_PATH', DATA_PATH . 'cahce/'. ucfirst(BIND_MODULE) .'/');
/* 日志目录 */
define('LOG_PATH', DATA_PATH . 'log/'. ucfirst(BIND_MODULE) .'/');
/* 静态缓存目录 */
