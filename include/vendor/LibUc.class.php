...
class LibUc {
     ...
     * @return void
     */
    public static function add_feed($id, $feed_type)
    {
        $feed = array();
     ...
     * @return  void
     */
    public static function get_linked_tags($tag_data)
    {
        //取所有应用列表
     ...
     * @return boolean
     */
    public static function exchange_points($uid, $fromcredits, $tocredits, $toappid, $netamount)
    {
