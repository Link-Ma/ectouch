...
CREATE TABLE IF NOT EXISTS `ecs_access` (
...
INSERT INTO `ecs_access` (`role_id`, `node_id`, `pid`, `level`, `module`) VALUES
(1, 8, 28, 2, NULL),
(1, 28, 13, 0, NULL),
(1, 13, 1, 0, NULL),
(1, 6, 2, 3, NULL),
...
CREATE TABLE IF NOT EXISTS `ecs_node` (
...
INSERT INTO `ecs_node` (`id`, `name`, `title`, `status`, `remark`, `pid`, `level`, `data`, `sort`, `display`) VALUES
...
INSERT INTO `ecs_role` (`id`, `name`, `pid`, `status`, `sort`, `remark`) VALUES
...
CREATE TABLE IF NOT EXISTS `ecs_role_user` (
...
--
-- 导出表中的数据 `ecs_role_user`
--

INSERT INTO `ecs_role_user` (`user_id`, `role_id`) VALUES
(3, 2),
(1, 1);
...
CREATE TABLE IF NOT EXISTS `ecs_admin` (
...
INSERT INTO `ecs_admin` (`id`, `username`, `password`, `role`, `status`, `remark`, `last_login_time`, `last_login_ip`, `last_location`) VALUES
